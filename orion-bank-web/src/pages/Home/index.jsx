          ...
          <div className="row">
            <div className="col-12 col-x1-8 mb-4 mb-x1-0">
              ...
              {!notificacoes && (
                <h6 className="mb-0">
                  {" "}
                  <span style={{ color: "#EB4E50" }}>1</span> notificação não
                  lida!
                </h6>
              )}
              ...
              {notificacoes && (
                <h6 className="mb-0">
                  {" "}
                  <span style={{ color: "#EB4E50" }}>0</span> notificações
                  recebidas!
                </h6>
              )}
            </div>
            ...
            <div className="card card-tale">
              ...
              <div>
                <Link onClick={hideMoney} style={{ cursor: "pointer" }}>
                  <i className="teste">
                    {hideEye && <img src={EyeOpen} alt="" />}

                    {!hideEye && <img src={EyeClose} alt="" />}
                  </i>
                </Link>
              </div>
            </div>
        ...
        <div className="row3">
          <div className="tabelita">
            <div className="card-body">
              <p className="card-title mb-0 titulo-tabela">
            ...
            <div className="card-cartao">
              ...
              <div className="middle">
                <div className="">
                  <Link to="#">
                    {" "}
                    <button type="submit" className="btn-solicita">
                      Solicitar
                    </button>{" "}
                  </Link>
                </div>
