...
const Login = () => {
  ...
  const [autenticarRequest, setAutenticarRequest] = useState({
    login: "",
    senha: "",
  });
  ...
  const handleSubmit = (e) => {
    ...
    if (validarPrenchimento()) login(autenticarRequest);
    else showErrorNotification("Preencha todos os campos!");
                ...
                <div className="col-lg-7">
                  <div className="p-5">
                    <div className="text-center">
                      <img
                        src={Titulo}
                        className="circulo-preto"
                        alt=""
                        draggable="false"
                      />
                      <h1
                        style={{ color: "black", opacity: "70%" }}
                        className="h4 mb-4 mt-0"
                      >
                        Login
                      </h1>
                    </div>
                    ...
                    <form className="user" onSubmit={handleSubmit}>
                      ...
                      <div className="form-group">
                        ...
                        <div className="text-right">
                          <Link to="/recuperar" className="forgot small">
                            Esqueceu sua senha?
                          </Link>
                        </div>
                      </div>
                      ...
                      <div className="buttonsLogin form-group">
                        ...
                        <Link to="/solicitarConta">
                          <button type="submit" className="botao-dois">
                            {" "}
                            Solicitar Conta{" "}
                          </button>
                        </Link>
