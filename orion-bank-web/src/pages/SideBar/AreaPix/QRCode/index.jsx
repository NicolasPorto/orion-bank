    ...
    <div className="container-qrcode">
      <div className="title-qrcode">
        <h3 className="titulo-h5">
          {" "}
          <img src={Icon} alt=""></img> Criar QRCode{" "}
        </h3>
      </div>
      <div className="card-qrcode">
        ...
        <div className="div-descricao">
          <h5 className="titulo-chaves">
            Para criar o QRCode selecione a chave pix desejada.
          </h5>
        </div>
        {chaves.length > 0 && (
                  ...
                  <tr key={index}>
                    ...
                    <td onClick={() => openModal(record.Chave_Pix)}>
                      <div className="tipo-chave">
                        <span>
                          <strong>{formatarEnum(record.TipoChave)}</strong>
                        </span>
                      </div>
        ...
        {chaves.length === 0 && (
          <div className="background-qr mt-3">
            ...
            <h5 className="mt-3" style={{ color: "#3f3d56" }}>
          ...
          <Modal.Body>
            <div className="modal-info-qr-qode">
              <div className="body-pagar mb-3">
                <label style={{ color: "#3f3d56", fontSize: "14px" }}>
                  Valor QRCode
                </label>
                <CurrencyInput
                  className="valor-qr-code"
                  value={valor}
              ...
              <div className="revisao-qrcode mt-4">
                ...
                <div className="adicionar-msg mt-3">
                  <label
                    className="add-mensagem"
                    onClick={() => setInfoIsOn(!infoIsOn)}
                  >
                    Adicionar mensagem
                  </label>
                  {infoIsOn && (
          ...
          <Modal.Body>
            <div className="qrcode-criado">
              <div className="div-descricao-qrcode">
                <h5 className="titulo-chaves">
                  Salve o EMV para compartilhar o seu QRCode.
                </h5>
              </div>
