    ...
    <div className="container-solicitar">
      <div className="title-solicitar">
        <h3 className="titulo-h5">
          {" "}
          <img alt="" src={PersonLock}></img> Solicitações de Contas
        </h3>
      </div>
                ...
                <tr key={index}>
                  ...
                  <td>
                    <Button
                      ...
                      type="submit"
                      value="Analisar"
                      onClick={() => openModal(record.conta)}
                    />
                  </td>
                  <td>
                    <Button
                      ...
                      type="submit"
                      value="Aprovar"
                      onClick={() => aprovarSolicitacaoConta(record)}
                    />
                  </td>
                  <td>
                    <Button
                      ...
                      type="submit"
                      value="Reprovar"
                      onClick={() => reprovarSolicitacaoConta(record.Codigo)}
                    />
                  </td>
                </tr>
              ))}
